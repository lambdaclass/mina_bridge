...
library Commitment {
    ...
    function msm(BN254.G1Point[] memory points, Scalar.FE[] memory scalars) public view returns (BN254.G1Point memory result) {
    ...
    function naive_msm(BN254.G2Point[] memory points, Scalar.FE[] memory scalars) public view returns (BN254.G2Point memory) {

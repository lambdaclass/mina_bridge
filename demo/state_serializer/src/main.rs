...
// {"data":{"bestChain":[{"creator":"B62qoA5XwfEVnXbcrzphGH1TVuqxeJ5bhX7vTS3hcxpQFHnStG3MQk9","stateHashField":"24924803968503832121419666918600454255868948649936693214146949523817136720847",
// "protocolState":{"consensusState":{"blockHeight":"303201"}}}]}}%

fn main() {
    // let query: serde_json::Value = serde_json::from_str(r#"
